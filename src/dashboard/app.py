...
def render_goal1_strengthen_impact(processor: DataProcessor, time_unit: str):
    ...
    st.markdown("<p style='font-size: 0.85rem; color: #718096; text-decoration: underline; text-align: center;'> Trends depict all books distributed (including to previously served children) per unique child this period.</p>", unsafe_allow_html=True)
